...
## Scaled Data
P1_WT_MED_UT <-  P1_WT[P1_WT$Treatment == "untreated",] %>% mutate_at(dataCols, scaleMedMad)
P2_WT_MED_UT <-  P2_WT[P2_WT$Treatment == "untreated",] %>% mutate_at(dataCols, scaleMedMad)
P3_WT_MED_UT <-  P3_WT[P3_WT$Treatment == "untreated",] %>% mutate_at(dataCols, scaleMedMad)
P4_WT_MED_UT <-  P4_WT[P4_WT$Treatment == "untreated",] %>% mutate_at(dataCols, scaleMedMad)
