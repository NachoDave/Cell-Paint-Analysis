...
# clst5 <- c(18, 25)
  ...
  clst_grps <- data.frame(Cluster = c("Cluster 2", "Cluster 2", "Cluster 1", "Cluster 1", "Cluster 1",
                                      ...
                                      "X", "X", "Cluster 3", "Cluster 4", "Cluster 4",
                                      "X", "Cluster 3", "Cluster 5", "Cluster 4", "Cluster 4",
                                      "X", "X", "X", "Cluster 4", "Cluster 5"))
  ...
  phm <- pheatmap(t(SOM_Code_HM_plot), show_colnames =  FALSE, show_rownames = FALSE, breaks = breaks, color = colors, 
                  cluster_cols = TRUE,
                   clustering_distance_cols = "canberra",  cutree_cols = clstCut, cluster_rows = FALSE, annotation_row = All_feature_Grps[, 1, drop = FALSE],
