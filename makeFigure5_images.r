...
clst = c(5, 3, 8, 8, 3, 3)
cyto_fac_ar <- c(0.995, 0.99, 0.98, 0.99 ,0.8, 1)
dna_fac_ar <- c(0.99, 0.98, 1, 0.98 ,0.9, 1)
mito_fac_ar <- c(0.995, 0.99, 0.995, 0.995, 0.995, 0.995)
# 
# ddx <- 5
# 
im_ar1 <- make_image_array(plates, wells, flds, clst, cyto_fac_ar, dna_fac_ar, mito_fac_ar, stack = "x", n = 3)
save.image(im_ar1, "/data/CEAT/ImageDatasets/CellPaint_WTCis_EpiCompoundDoseResponse/Figures/Figure 6 panels/clst1.png")
...
clst = c(1, 10, 9, 9, 1, 2)
cyto_fac_ar <- c(0.995, 0.99, 0.99, 0.99 ,0.994, 0.98)
dna_fac_ar <- c(0.99, 0.98, 0.98, 0.98 ,0.9, 0.94)
mito_fac_ar <- c(0.99, 0.99, 0.995, 0.998, 0.99, 0.94)
# 
# ddx <- 6
# 
im_ar2 <- make_image_array(plates, wells, flds, clst, cyto_fac_ar, dna_fac_ar, mito_fac_ar, n = 3)
save.image(im_ar2, "/data/CEAT/ImageDatasets/CellPaint_WTCis_EpiCompoundDoseResponse/Figures/Figure 6 panels/clst2.png")
...
cyto_fac_ar <- c(0.95, 0.98, 0.99, 0.993 ,0.995, 0.97)
dna_fac_ar <- c(0.98, 0.92, 0.993, 0.99 ,0.96, 0.98)
mito_fac_ar <- c(0.996, 0.99, 0.999, 0.992, 0.993, 0.992)

im_ar3 <- make_image_array(plates, wells, flds, clst, cyto_fac_ar, dna_fac_ar, mito_fac_ar, n = 3)
save.image(im_ar3, "/data/CEAT/ImageDatasets/CellPaint_WTCis_EpiCompoundDoseResponse/Figures/Figure 6 panels/clst3.png")
...
cyto_fac_ar <- c(0.995, 0.99, 0.98, 0.99 ,0.95, 0.97)
dna_fac_ar <- c(0.99, 0.98, 0.97, 0.98 ,0.9, 0.93)

mito_fac_ar <- c(0.995, 0.995, 0.975, 0.985, 0.95, 0.94)
# 
# ddx <- 6

im_ar4 <- make_image_array(plates, wells, flds, clst, cyto_fac_ar, dna_fac_ar, mito_fac_ar, n = 3)
save.image(im_ar4, "/data/CEAT/ImageDatasets/CellPaint_WTCis_EpiCompoundDoseResponse/Figures/Figure 6 panels/clst4.png")
# 
# ## Cluster 5
plates = c('P1', 'P1', 'P9', 'P1', 'P5', 'P1')
wells = c('E - 09', 'F - 05', 'F - 11', 'A - 08', 'F - 05', 'E - 10')
flds = c('12', '25', '16', '11', '14', '07')
obs = c(89, 22, 56, 35, 58, 71)
clst = c(18, 18, 18, 25, 25, 25)
cyto_fac_ar <- c(0.99, 0.998, 0.99, 0.998 ,0.99, 0.96)
dna_fac_ar <- c(0.99, 0.98, 0.97, 0.98 ,0.96, .95)
mito_fac_ar <- c(0.997, 1, 0.99, 0.995, 0.99, 0.975)
